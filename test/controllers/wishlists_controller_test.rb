...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { product_id: @wishlist.product_id, qty: @wishlist.qty, user_id: @wishlist.user_id } }, as: :json
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { product_id: @wishlist.product_id, qty: @wishlist.qty, user_id: @wishlist.user_id } }, as: :json
    assert_response 200
  end
